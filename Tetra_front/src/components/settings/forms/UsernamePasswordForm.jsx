// src/components/settings/direct/UsernamePasswordForm.jsx
...
import { UsernamePasswordSkeleton } from '../../skeletons/index.js';
...
const UsernamePasswordForm = () => {
    ...
    if (isLoadingUser || !user) {
        return <UsernamePasswordSkeleton onBack={() => navigate('/settings/account')} />;
    }
    ...
    return (
        <div className="w-full h-full flex flex-col overflow-y-auto custom-scrollbar bg-white dark:bg-[#09090b]">
            ...
            <div className="p-4 md:px-6 md:py-2 max-w-[600px]">
