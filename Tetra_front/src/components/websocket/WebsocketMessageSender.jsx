...
const WebSocketMessageSender = ({
    ...
    return (
        <div className="flex-1 flex flex-col  bg-white/30 dark:bg-[#09090b]/10 p-4">
            <div className="flex flex-col h-full space-y-4 min-h-0">
                ...
                <div className=" flex flex-col min-h-0 space-y-2">
                    ...
                    <div className=" border border-main bg-neutral-950 rounded-2xl flex overflow-hidden min-h-[160px]">
                        {/* Line Numbers mock */}
