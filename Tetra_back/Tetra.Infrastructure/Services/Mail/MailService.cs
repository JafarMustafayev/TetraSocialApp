namespace Tetra.Infrastructure.Services.Mail;

public class MailService(
    IMailSender mailSender,
    ILocalizationService localizer) : IMailService
{
    public async Task SendConfirmationMail(string to, string link)
    {
    ...
    public async Task SendPasswordResetMail(string to, string link)
    {
