// src/components/apiTester/api-tester-params-tab.jsx
import React from 'react';
import { Plus, Trash2 } from 'lucide-react';

const ParamsTab = ({ queryParams, addQueryParam, updateQueryParam, removeQueryParam }) => {
    return (
        <div className="space-y-3">
            <div className="flex items-center justify-between">
                <span className="text-[10px] font-extrabold tracking-wider text-gray-400 uppercase">Query Parameters</span>
                <button
                    type="button"
            ...
            <div className="space-y-2 max-h-[300px] overflow-y-auto pr-1 select-text">
                ...
                {queryParams.length === 0 && (
                    <div className="text-center py-10 text-xs text-gray-400 border border-dashed border-gray-200 dark:border-neutral-850 rounded-xl">
                        No search queries defined. Click "Add Row" to build parameters.
                    </div>
                )}
            </div>
        </div>
